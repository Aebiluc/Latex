...
À la fin de la sous-section \ref{mere} (en page \pageref{mere}), les six espaces verticaux s’obtiennent à l’aide de
six commandes \textbackslash bigskip placées au début de six nouveaux paragraphes sans indentation. Le gros espace horizontal dans la section \ref{moralité} {en page \pageref{moralité} } mesure cinq centimètres. Les espaces entre
les caractères spéciaux suivants ont exactement la même largeur qu’un M : \_ \# \$ \&.
