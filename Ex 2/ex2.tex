...
À la fin de la sous-section \ref{mere} (en page 2), les six espaces verticaux s’obtiennent à l’aide de
six commandes \textbackslash bigskip placées au début de six nouveaux paragraphes sans indentation. Le gros espace horizontal dans la section 4 {en page 2} mesure cinq centimètres. Les espaces entre
